...
E.Media = {
	...
	Fonts = {
		...
		FuturaBT = M..[[Fonts\FuturaBT.ttf]],
		BigNoodleToo = M..[[Fonts\BigNoodleToo.ttf]],
		Steelfish = M..[[Fonts\steelfish.ttf]],
		ToxiIcons = M..[[Fonts\ToxiIcons.ttf]]
	},
	Sounds = {
	...
	Textures = {
		...
		Arrow2 = M..[[Textures\Arrow2.tga]],
		Arrow3 = M..[[Textures\Arrow3.tga]],
		...
		Quest = M..[[Textures\quest.tga]],
		ToxiDC = M..[[Textures\toxi-dc.tga]],
		ToxiDead = M..[[Textures\toxi-dead.tga]],
		...
		ToxiUIDps = M..[[Textures\toxi-dps.tga]],
		ToxiUIHeal = M..[[Textures\toxi-heal.tga]],
		ToxiUITank = M..[[Textures\toxi-tank.tga]]
	}
}
...
LSM:Register("font", "Futura BT", E.Media.Fonts.FuturaBT)
LSM:Register("font", "BigNoodleToo", E.Media.Fonts.BigNoodleToo)
LSM:Register("font", "Steelfish", E.Media.Fonts.Steelfish)
LSM:Register("font", "ToxiIcons", E.Media.Fonts.ToxiIcons)
